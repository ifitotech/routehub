  ...
  return <ManagerShell active="routes" branchName={defaultBranch?.name} roleLabel={t.managerRole}>
    ...
    {loading ? <section className={styles.routeGrid} aria-label={c.loadError}>
      ...
      {dayView === 'today' && inProgressRoutes.length > 0 && <section className={styles.routeSection}>
        ...
        <RouteRows items={inProgressRoutes} locale={locale} c={c} driverIndex={driverIndex} onCancel={cancelRoute} onMove={moveRoute} onTogglePause={toggleRoutePause} onPrioritize={prioritizeRoute} onMoveTomorrow={moveRouteToTomorrow} busyRouteId={busyRouteId} managing={managing} />
      </section>}
      {dayView === 'today' && scheduledTodayRoutes.length > 0 && <section className={styles.routeSection}>
        ...
        <RouteRows items={scheduledTodayRoutes} locale={locale} c={c} driverIndex={driverIndex} onCancel={cancelRoute} onMove={moveRoute} onTogglePause={toggleRoutePause} onPrioritize={prioritizeRoute} onMoveTomorrow={moveRouteToTomorrow} busyRouteId={busyRouteId} managing={managing} />
      </section>}
