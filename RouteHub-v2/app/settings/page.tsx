      ...
      <div className={styles.page}>
        ...
        {!isCeo && (
          <section className={styles.card}>
            ...
            <Link className={styles.row} href="/settings/billing">
              <span className={styles.copy}><strong>{t.planBilling}</strong><small>{trialEnd ? `${t.premiumTrial}: ${new Date(trialEnd).toLocaleDateString(locale)}` : copy.billingHelp}</small></span>
