...
export default function AppBottomNav() {
  ...
  if (pathname === '/' || pathname === '/login' || pathname === '/auth/callback' || pathname === '/activate-invitation' || pathname === '/product' || pathname === '/how-it-works' || pathname === '/for-drivers' || hasLocalNav) return null
