...
export default function Login() {
  ...
  return <main className="landing">
    <header className="landing-nav"><Image src="/routehub-regular-app.jpg" alt="RouteHub" width={774} height={774} priority/><button className="secondary" onClick={() => { setMessage(''); setDialog('sign-in') }}>Sign in</button></header>
    ...
    {dialog && <div className="modal-backdrop"><section className="card modal login-card" aria-labelledby="access-dialog-title"><button className="close" aria-label="Close" onClick={closeDialog}>×</button><Image src="/routehub-regular-app.jpg" alt="RouteHub" className="login-logo" width={774} height={774}/>
