...
export default function InstallAppCard() {
  ...
  const copy = useMemo(() => locale === 'es'
    ? {title:'Instalar RouteHub',help:'Instala la app para abrirla más rápido y recibir notificaciones.',install:'Instalar app',download:'Descargar APK',guide:'Ver guía',close:'Cerrar',iphone:'En iPhone: abre RouteHub en Safari, pulsa Compartir y luego “Añadir a pantalla de inicio”. Después abre la app desde el nuevo icono.',android:'En Android: descarga el APK, abre el archivo y confirma la instalación. Si Android lo solicita, activa temporalmente “Permitir desde esta fuente” para el navegador o Archivos.',apkHelp:'Después de instalarla, abre RouteHub desde el icono azul y vuelve a Settings para conceder ubicación, cámara y notificaciones.'}
    : locale === 'fr'
      ...
      : {title:'Install RouteHub',help:'Install the app for faster access and route notifications.',install:'Install app',download:'Download APK',guide:'View guide',close:'Close',iphone:'On iPhone: open RouteHub in Safari, tap Share, then “Add to Home Screen”. Open RouteHub from the new icon.',android:'On Android: download the APK, open it and confirm installation. If Android asks, temporarily enable “Allow from this source” for your browser or Files.',apkHelp:'After installing, open RouteHub and use Settings to allow location, camera and notifications.'}, [locale])
