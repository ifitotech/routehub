...
export default function InstallAppCard() {
  ...
  const copy = useMemo(() => locale === 'es'
    ? {title:'Instalar RouteHub Driver',help:'Instala la app para abrirla más rápido y recibir notificaciones.',install:'Instalar app',download:'Descargar APK',guide:'Ver guía',close:'Cerrar',iphone:'En iPhone: abre RouteHub Driver en Safari, pulsa Compartir y luego “Añadir a pantalla de inicio”. El icono del Driver aparece antes de iniciar sesión.',android:'En Android: descarga el APK, abre el archivo y confirma la instalación. Si Android lo solicita, activa temporalmente “Permitir desde esta fuente” para el navegador o Archivos.',apkHelp:'Después de instalarla, abre RouteHub Driver desde el icono azul y vuelve a Settings para conceder ubicación, cámara y notificaciones.'}
    : locale === 'fr'
      ? {title:'Installer RouteHub',help:'Installez l’application pour un accès rapide et les notifications.',install:'Installer',download:'Télécharger APK',guide:'Voir le guide',close:'Fermer',iphone:'Sur iPhone : ouvrez RouteHub dans Safari, touchez Partager, puis « Ajouter à l’écran d’accueil ». Ouvrez ensuite l’app depuis la nouvelle icône.',android:'Sur Android : téléchargez l’APK, ouvrez le fichier et confirmez. Si Android le demande, activez temporairement « Autoriser depuis cette source » pour le navigateur ou Fichiers.',apkHelp:'Après l’installation, ouvrez RouteHub puis Settings pour autoriser la position, la caméra et les notifications.'}
      : {title:'Install RouteHub Driver',help:'Install the app for faster access and route notifications.',install:'Install app',download:'Download APK',guide:'View guide',close:'Close',iphone:'On iPhone: open RouteHub Driver in Safari, tap Share, then “Add to Home Screen”. The Driver icon appears before sign-in.',android:'On Android: download the APK, open the file and confirm installation. If Android asks, temporarily enable “Allow from this source” for your browser or Files.',apkHelp:'After installing, open RouteHub Driver and use Settings to allow location, camera and notifications.'}, [locale])
