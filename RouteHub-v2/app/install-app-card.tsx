...
export default function InstallAppCard() {
  ...
  const copy = useMemo(() => locale === 'es'
    ? {title:'Instalar RouteHub',help:'Instala la app para abrirla más rápido y recibir notificaciones.',install:'Instalar app',download:'Descargar APK',guide:'Ver guía',close:'Cerrar',iphone:'En iPhone: abre RouteHub en Safari, pulsa Compartir y luego “Añadir a pantalla de inicio”. Después abre la app desde el nuevo icono.',android:'En Android: abre RouteHub en Chrome y pulsa “Instalar app” o “Añadir a pantalla de inicio”.',apkHelp:'Si quieres la aplicación Android, descarga el APK e instálalo.'}
    : locale === 'fr'
      ? {title:'Installer RouteHub',help:'Installez l’application pour un accès rapide et les notifications.',install:'Installer',download:'Télécharger APK',guide:'Voir le guide',close:'Fermer',iphone:'Sur iPhone : ouvrez RouteHub dans Safari, touchez Partager, puis « Ajouter à l’écran d’accueil ». Ouvrez ensuite l’app depuis la nouvelle icône.',android:'Sur Android : ouvrez RouteHub dans Chrome et touchez « Installer l’application » ou « Ajouter à l’écran d’accueil ». ',apkHelp:'Pour l’application Android, téléchargez et installez l’APK.'}
      : {title:'Install RouteHub',help:'Install the app for faster access and route notifications.',install:'Install app',download:'Download APK',guide:'View guide',close:'Close',iphone:'On iPhone: open RouteHub in Safari, tap Share, then “Add to Home Screen”. Open RouteHub from the new icon.',android:'On Android: open RouteHub in Chrome and tap “Install app” or “Add to Home screen”.',apkHelp:'For the Android app, download and install the APK.'}, [locale])
