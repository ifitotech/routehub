...
const [recipientError,setRecipientError]=useState('')
  ...
  const dayMapStops=dayRoutes.map(route=>({id:route.id,address:route.destination_address,label:route.destination_name||route.destination_address,kind:stopKind(route.mission_type),orderNumber:route.order_number,notes:route.notes,position:route.position,pastDue:routeFocusDate<today&&!['completed','issue','cancelled'].includes(route.status),pending:['published','pending'].includes(route.status)}))
