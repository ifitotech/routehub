...
export default function Driver() {
  ...
  return <main className={`app ${styles.page}`}>
    ...
    {routeView&&!current&&<section className={styles.routeOverlay} aria-label="Route details"><header className={styles.routeOverlayHeader}><button type="button" onClick={()=>setRouteView(null)} aria-label="Back"><ArrowLeft size={20}/></button><strong>Route</strong><span /></header><div className={styles.empty}><List size={24}/><h2>{t.noRoutesToday}</h2><p>{t.createRouteWhenReady}</p></div></section>}
