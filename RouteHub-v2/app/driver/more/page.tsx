...
export default function DriverMore(){
  return <main className={`app driver-dashboard ${styles.page}`}>
    <header className={styles.header}><Link className={styles.brand} href="/driver"><Image src="/routehub-driver-new.jpg" alt="" width={40} height={40} priority/><span>Route<em>Hub</em></span></Link></header>
