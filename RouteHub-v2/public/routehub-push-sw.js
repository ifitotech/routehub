...
self.addEventListener('push', event => {
  ...
  const options = { body: data.body || 'You have a new route update.', icon: '/routehub-driver-app.jpg', badge: '/routehub-driver-app.jpg', tag: data.tag || 'routehub-update', data: { href: data.href || '/driver' }, renotify: true }
