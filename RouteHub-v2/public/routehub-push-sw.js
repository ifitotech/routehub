...
self.addEventListener('push', event => {
  ...
  const options = { body: data.body || 'You have a new route update.', icon: '/routehub-driver-new.jpg?v=19', badge: '/routehub-driver-new.jpg?v=19', tag: data.tag || 'routehub-update', data: { href: data.href || '/driver' }, renotify: true }
